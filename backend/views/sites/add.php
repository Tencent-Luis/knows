...
<div class="row">
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
            <form id="sites_form" class="form-horizontal" data-parsley-validate="true">
                <input type="hidden" name="<?= Yii::$app->request->csrfParam; ?>" value="<?= Yii::$app->request->csrfToken; ?>">
                <div class="form-group">
                    <label class="col-md-2 control-label">站点名称 * </label>
                    <div class="col-md-9">
                        <input type="text" name="site_name" class="form-control" placeholder="站点名称" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <select id="site_status" name="site_status" class="form-control js-select2" data-parsley-required="true" data-parsley-required-message="请选择站点状态!">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">网站类型</label>
                    <div class="col-md-9">
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadios" value="pc" checked>PC
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadios" value="mobile">Mobile
                        </label>
                    </div>
                </div>
                <div class="form-group">
